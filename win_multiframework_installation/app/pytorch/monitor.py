...
class monitor:
    def __init__(self,image_height,image_width):
        ...
        # self.bar_set={'x':int(image_height//20),'y':int(image_width//20),'width':int(image_width//6),'height':int(image_height//20),'space':int(image_height//40)}
        bar_show_item_count=len(self.device_usage)-1 #except cpu
        # self.bar_set = {
        #                 'bar_x':int(image_height//20),'bar_y':int(image_width//20),
        #                 'bar_h':int(image_height//25),'bar_w':int(image_width//25),
        #                 'word_h':int(image_height//25),'word_w':200,'word_size':int(image_width//25)
        #                 'space_h':int(image_height//40),'space_w':int(image_height//40)
        #                 }
        # self.bar_bkgd_set = {
        #                 'box_x':self.bar_set['bar_x']-self.bar_set['space_w'],'box_y':self.bar_set['bar_y']-self.bar_set['space_h'],
        #                 'box_w':self.bar_set['word_w']+self.bar_set['bar_w']+self.bar_set['space_w']*2,'box_y':self.bar_set['word_h']+self.bar_set['bar_h']+self.bar_set['space_h']*bar_show_item_count,
        #                 }
